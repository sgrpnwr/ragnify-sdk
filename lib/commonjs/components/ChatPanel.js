  ...
  const scrollToBottom = () => {
    setTimeout(() => {
      ...
      (_scrollViewRef$curren = scrollViewRef.current) === null ||
        _scrollViewRef$curren === void 0 ||
        _scrollViewRef$curren.scrollToEnd({
          animated: true,
        });
    }, 100);
  };
    ...
    if (answerRef && scrollViewRef.current) {
      answerRef.measureLayout(
        ...
        (_x, y) => {
          ...
          (_scrollViewRef$curren2 = scrollViewRef.current) === null ||
            _scrollViewRef$curren2 === void 0 ||
            _scrollViewRef$curren2.scrollTo({
              y: Math.max(0, y - 20),
              animated: true,
            });
        },
    ...
    try {
      ...
      if (!res.ok) {
        ...
        try {
          ...
          errMsg =
            (payload === null || payload === void 0 ? void 0 : payload.error) ||
      ...
      if (contentType.includes("application/json")) {
        ...
        answer =
          (data === null || data === void 0 ? void 0 : data.answer) ??
          (data === null || data === void 0 ? void 0 : data.banswer) ??
          JSON.stringify(data ?? {});
      } else {
