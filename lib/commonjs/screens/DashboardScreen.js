...
function AdminDashboard({
  ...
  const { user, accessToken, logout, config } = (0,
  _AuthContext.useSapientAuth)();
  const baseUrl =
    (config === null || config === void 0 ? void 0 : config.baseUrl) ||
    "https://ragnifyms.sgrpnwr.com";
  ...
  const isSuperAdmin =
    ...
    _user$roles === void 0
      ? void 0
      : _user$roles.includes("super_admin")) || false;
  const isTenantAdmin =
    (user === null ||
    user === void 0 ||
    ...
    _user$roles2 === void 0
      ? void 0
      : _user$roles2.includes("tenant_admin")) || false;
  ...
  const progressAnim = _react.default.useRef(
  ...
  const showAlert = (title, message) => {
    if (
      ...
      typeof (globalThis === null || globalThis === void 0
        ? void 0
  ...
  const fileInputRef =
    _reactNative.Platform.OS === "web" ? _react.default.useRef(null) : null;
  ...
  const renderUploadTab = () =>
    /*#__PURE__*/ _react.default.createElement(
      ...
      /*#__PURE__*/ _react.default.createElement(
        ...
        "Upload PDF documents to the knowledge base. Files will be processed and indexed automatically.",
      ),
      isSuperAdmin
        ? /*#__PURE__*/ _react.default.createElement(
            _reactNative.View,
            ...
            /*#__PURE__*/ _react.default.createElement(
              ...
              "\n\n",
              "Please log in as a tenant admin to upload documents to a specific tenant's knowledge base.",
            ),
          )
        : /*#__PURE__*/ _react.default.createElement(
  ...
  const renderTenantsTab = () =>
    /*#__PURE__*/ _react.default.createElement(
      ...
      {
        style: styles.tabContent,
        refreshControl: /*#__PURE__*/ _react.default.createElement(
    ...
    /*#__PURE__*/ _react.default.createElement(
      ...
      /*#__PURE__*/ _react.default.createElement(
        ...
        isSuperAdmin
          ...
          : `Manage users in your tenant (${user === null || user === void 0 ? void 0 : user.tenantId})`,
      ),
      loading
        ? /*#__PURE__*/ _react.default.createElement(
            _reactNative.ActivityIndicator,
          ...
          ? users.map((u) => {
              ...
              return /*#__PURE__*/ _react.default.createElement(
                ...
                /*#__PURE__*/ _react.default.createElement(
                  ...
                  isSuperAdmin &&
                    ((_u$tenant = u.tenant) === null || _u$tenant === void 0
                      ? void 0
                      : _u$tenant.tenantId) &&
                    /*#__PURE__*/ _react.default.createElement(
                      _reactNative.Text,
    ...
    /*#__PURE__*/ _react.default.createElement(
      ...
      /*#__PURE__*/ _react.default.createElement(
        ...
        /*#__PURE__*/ _react.default.createElement(
          ...
          isSuperAdmin
            ? "SUPER ADMIN"
            : `${user === null || user === void 0 ? void 0 : user.tenantId} ADMIN`,
        ),
      ),
