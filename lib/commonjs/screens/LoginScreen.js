...
function LoginScreen({
  ...
  const { setUser, setTokens, config, organisationMetadata } = (0,
  ...
  async function handleLogin() {
    ...
    try {
      ...
      const accessToken =
        (data === null ||
        data === void 0 ||
        (_data$data = data.data) === null ||
        _data$data === void 0
          ? void 0
          : _data$data.accessToken) ??
        ...
        _data$data2 === void 0
          ? void 0
          : _data$data2.access_token) ??
        (data === null || data === void 0 ? void 0 : data.access_token) ??
        null;
      const refreshToken =
        (data === null ||
        data === void 0 ||
        (_data$data3 = data.data) === null ||
        _data$data3 === void 0
          ? void 0
          : _data$data3.refreshToken) ??
        (data === null ||
        data === void 0 ||
        (_data$data4 = data.data) === null ||
        _data$data4 === void 0
          ? void 0
          : _data$data4.refereshToken) ??
        (data === null || data === void 0 ? void 0 : data.refreshToken) ??
        (data === null || data === void 0 ? void 0 : data.refresh_token) ??
        (data === null || data === void 0 ? void 0 : data.refereshToken) ??
        null;
