...
var _LogoutButton = _interopRequireDefault(
...
function ChatScreen({ onLogout, onNavigateToDashboard }) {
  const { user, logout, isAdmin, isSuperAdmin, accessToken, config } = (0,
            ...
            /*#__PURE__*/ _react.default.createElement(_ChatPanel.default, {
              ...
              baseUrl:
                (config === null || config === void 0
                  ? void 0
                  : config.baseUrl) || "https://ragnifyms.sgrpnwr.com",
              tenantId:
                (user === null || user === void 0 ? void 0 : user.tenantId) ||
                "",
            }),
