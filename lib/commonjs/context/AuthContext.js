...
const SapientAuthProvider = ({
  ...
  function validateRegisterInput(firstName, lastName, email, pass, roles) {
    const errors = [];
    // Email
  ...
  async function register(firstName, lastName, email, pass, roles) {
    const errors = validateRegisterInput(firstName, lastName, email, pass, roles);
    if (errors.length > 0) {
