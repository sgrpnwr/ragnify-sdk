...
import { ActivityIndicator, Alert, RefreshControl, ScrollView, StyleSheet, Text, TextInput, TouchableOpacity, View, Platform } from "react-native";
...
export default function AdminDashboard({
  ...
  const fetchUsers = async () => {
    try {
      ...
      Alert.alert("Error", (error === null || error === void 0 ? void 0 : error.message) || "Failed to load users");
    } finally {
      setLoading(false);
    }
  };
  ...
  const fetchTenants = async () => {
    try {
      ...
      Alert.alert("Error", (error === null || error === void 0 ? void 0 : error.message) || "Failed to load tenant information");
    } finally {
      setLoading(false);
    }
  };
